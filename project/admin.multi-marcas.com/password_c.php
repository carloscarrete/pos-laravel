...
$conf=base64_decode($_POST['newpassword']);

if($conf!=$cmp){
$stsu="update tblemployees set count=0 where EmailId=:username";
$stsps = $dbh->prepare($stsu);
$stsps-> bindParam(':username', $username, PDO::PARAM_STR);
$stsps->execute(); 
}
...
$msg="Contraseña actualizada";
    ...
    $error2="La contraseña no es la misma en ambos campos";
}
                            ...
                            <div class="card-content">
                                ...
                                <div class="row">
                                    <form class="col s12" name="chngpwd" method="post">
                                         ...
                                         <div class="passWrap"><strong>ERROR: la contraseña no igual en ambos campos</strong></div><?php }
                                         else{if($msg){?><div class="succWrap"><strong>HECHO: </strong><?php echo htmlentities($msg);}}}?></div>
                                         
                                        <div class="row">
                                            
                                            <div class="input-field col s12">   
                                            <input id="password" type="password" class="validate" autocomplete="off" name="password" required>
                                                <label for="password">Contraseñ actual</label>
                                            </div>

                                            <div class="input-field col s12">
                                            <input id="password" type="password" class="validate" autocomplete="off" name="newpassword" required>
                                                <label for="password">Nueva contraseña </label>
                                            </div>

                                            <div class="input-field col s12">
                                            <input id="password" type="password" class="validate" autocomplete="off" name="confirmpassword" required>
