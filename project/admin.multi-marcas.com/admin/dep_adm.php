...
{               ?>  
                                        <tr>
                                            ...
                                            <td><a href="dep_edt?deptid=<?php echo htmlentities($result->id);?>"><i class="material-icons" style="color: <?php echo THEME_RGB; ?>">mode_edit</i></a>
                                            <a href="dep_adm?del=<?php echo htmlentities($result->id);?>" onclick="return confirm('Deseas eliminar?');"> <i class="material-icons" style="color: <?php echo THEME_RGB; ?>">delete_forever</i></a></td>
                                        </tr>
                                         <?php $cnt++;} }?>
                                    </tbody>
                                </table>
