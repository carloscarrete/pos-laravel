...
$mes=date('m');    
$id=$_GET['inst'];
$sql = "UPDATE tblpedido SET reciv='1',MesR=:mes, FechaR=:f WHERE id=:id";
...
header("Location: client_art_conf?empid=$usuario");
}?>                
                            <div class="card-content">
                                ...
                                <a href="client_art_conf?empid=<?php echo htmlentities($usuario);?>"> <i class="btn btn-warning orange">EN PROCESO</i></a>
...
$sql = "SELECT * from tblpedido WHERE conf='1' AND pross='1' AND reciv<>'1' AND entrg<>'1' AND cliente=:clientno ORDER BY Mes,Fecha";
$query = $dbh -> prepare($sql);
...
{                               
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="client_art_conf?inst=<?php echo htmlentities($result->id);?>&empid=<?php echo htmlentities($usuario);?>"> <i class="material-icons" style="color: <?php echo THEME_RGB; ?>" title="EN TIENDA">store</i></a>
                                            </td>
                                        </tr>
                                            <?php                                        
