            ...
            <main class="mn-inner">
                <!-- Mostrar -->
                            <div class="card-content">
                                ...
                                <a href="client_art_den?empid=<?php echo htmlentities($usuario);?>"> <i class="btn btn-warning orange">RECHAZADOS</i></a>
                            </div>
...
$sql = "SELECT * from tblpedido WHERE conf='1' AND pross='2' AND cliente=:clientno  ORDER BY MesR,FechaR";
