...
header("Location: client_art_rec?empid=$usuario");
                            ...
                            <div class="card-content">
                                ...
                                <a href="client_art_rec?empid=<?php echo htmlentities($usuario);?>"> <i class="btn btn-warning orange">EN TIENDA</i></a>
...
$sql = "SELECT * from tblpedido WHERE conf='1' AND pross<>'2' AND reciv='1' AND entrg='0' AND cliente=:clientno  ORDER BY Mes,Fecha";
$query = $dbh -> prepare($sql);
...
{                               
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="client_art_rec?entr=<?php echo htmlentities($result->id);?>&empid=<?php echo htmlentities($usuario);?>"> <i class="material-icons" style="color: <?php echo THEME_RGB; ?>" title="ENTREGAR">how_to_reg</i></a>
                                            </td>
                                        </tr>
                                            <?php                                        
