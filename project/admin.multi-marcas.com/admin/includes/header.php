                ...
                <nav class="<?php echo THEME_HEAD;?> darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">      
                            <span href="https://www.facebook.com/serv.tec.la" class="chapter-title">Administracion</span>
                        </div>
...
{               ?>  
                                    ...
                                    <li>
                                        <a href="sls_adm?leaveid=<?php echo htmlentities($result->lid);?>">
                                        <div class="notification">
                                            <div class="notification-icon circle purple"><i class="material-icons">done</i></div>
                                            <div class="notification-text"><p><b><?php echo htmlentities($result->FirstName." ".$result->LastName);?><br />(<?php echo htmlentities($result->EmpId);?>)</b> esta solicitando permiso</p><span> el <?php echo htmlentities($result->PostingDate);?></b</span></div>
                                        </div>
                                        </a>
                                    </li>
                                   <?php }} ?>
