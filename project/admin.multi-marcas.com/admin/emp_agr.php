...
$email=$_POST['email']; 
$password=base64_encode(PASS_PRED); 
$gender=$_POST['gender']; 
$dob=$_POST['dob']; 
...
$sql_res="INSERT INTO tblrespaldo(EmpId) VALUE(:empid)";
$query_res = $dbh->prepare($sql_res);
$query_res->bindParam(':empid',$empid,PDO::PARAM_STR);
$query_res->execute();
$lastInsertId_res = $dbh->lastInsertId();
...
<label for="empcode">Codigo unico de empleado</label>
...
<div class="input-field col s12">
<label for="email">Username (Nombre para iniciar sesión)</label>
<input  name="email" type="text" id="email" onBlur="checkAvailabilityEmailid()" autocomplete="off" required>
<span id="emailid-availability" style="font-size:12px;"></span> 
</div>

<b>Contraseña por defecto: </b><b style="color:green"><?php echo PASS_PRED; ?></b>
...
<b>Horario por defecto: </b><b style="color:green"> Lunes a Sabado</b>
<h6>(L-V) Horario: <b style="color:red"> 10:05 - 19:00 </b>, (S) Horario: <b style="color:red"> 10:05 - 18:00 </b></h6>
<h6>Puedes cambiar el horario en la pestaña asistencias.</h6>
</div>
</div>
