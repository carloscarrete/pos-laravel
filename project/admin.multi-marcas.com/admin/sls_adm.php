    ...
    <body class="body">
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <a href="sls_h_all" onclick=""> <i class="btn btn-warning <?php echo THEME_HEAD; ?>">Regresar</i></a>
                    </div>
...
{         
      ?>  
                                        ...
                                        <tr>
                                            <td style="font-size:16px;"> <b>Nombre del empleado:</b></td>
                                              <td><a href="editemployee?empid=<?php echo htmlentities($result->id);?>" target="_blank">
                                          ...
                                          <tr>
                                            ...
                                            <td><?php echo htmlentities($result->EmailId);?></td>
                                             <td style="font-size:16px;"><b>Telefono de Contacto  :</b></td>
  ...
  <tr>
                                             <td style="font-size:16px;"><b>Justificante :</b></td>
                                            <td><?php echo htmlentities($result->LeaveType);?></td>
                                             <td style="font-size:16px;"><b>Fechas:</b></td>
                                            <td>De <?php echo htmlentities($result->FromDate);?> al <?php echo htmlentities($result->ToDate);?></td>
                                            <td style="font-size:16px;"><b>Fecha de Solicitud</b></td>
                                           <td><?php echo htmlentities($result->PostingDate);?></td>
                                        </tr>

<tr>
                                             <td style="font-size:16px;"><b>Descripción de la solicitud: </b></td>
                                            <td colspan="5"><?php echo htmlentities($result->Description);?></td>
                                          
                                        </tr>

<tr>
<td style="font-size:16px;"><b>Estado de solicitud :</b></td>
...
<a class="modal-trigger waves-effect waves-light btn <?php echo THEME_HEAD; ?>" href="#modal1">Tomar&nbsp;Accion</a>
    ...
    <div class="modal-content" style="width:90%">
        <h4>Tomar accion</h4>
          <select class="browser-default" name="status" required="">
                                        ...
                                        name="description" placeholder="Description" length="500" maxlength="500" required></textarea></p>
    </div>
    <div class="modal-footer" style="width:90%">
       <input type="submit" class="waves-effect waves-light btn <?php echo THEME_HEAD; ?> m-b-xs" name="update" value="Confirmar">
    </div>
