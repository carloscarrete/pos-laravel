                            ...
                            <div class="card-content">
                                ...
                                <table id="example" class="display responsive-table ">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th width="300">Nombre del empleado</th>
...
{         
      ?>  
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="emp_edt?empid=<?php echo htmlentities($result->id);?>" target="_blank"><?php echo htmlentities($result->FirstName." ".$result->LastName);?>(<?php echo htmlentities($result->EmpId);?>)</a></td>
                                            ...
                                            <td><a href="sls_adm?leaveid=<?php echo htmlentities($result->lid);?>" class="waves-effect waves-light btn <?php echo THEME_HEAD; ?> m-b-xs"  > Ver detalles</a></td>
                                    </tr>
                                         <?php $cnt++;} }?>
                                    </tbody>
                                </table>
