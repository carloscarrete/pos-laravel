                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo htmlentities($result->mobile);?></td>
                                             <td><?php $stats=$result->Status;
                                                ...
                                                if($stats==1){?>
                                                    <a class="waves-effect waves-green btn-flat m-b-xs">ACTIVO</a><?php
                                                } 
                                                 else { 
                                                    if($result->Status != 2){ 
                                                        if($result->count>=3){?>
                                                            <a class="waves-effect waves-orange btn-flat m-b-xs">BLOQUEADO</a><?php
                                                        }
                                                        else {?>
                                                            <a  class="waves-effect waves-orange btn-flat m-b-xs">SUSPENDIDO</a> <?php 
                                                        }    
                                                    }
                                                } 
                                                ?>
                                            ...
                                            <td>
                                            <a href="client_art?empid=<?php echo htmlentities($result->id);?>" target="popup"
