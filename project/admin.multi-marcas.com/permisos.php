...
$isread=0;
if($fromdate > $todate){
                $error=" La fecha de inicio no puede ser menor a la final ";
           }else{
...
<option value="">Selecciona tipo de justificante...</option>
