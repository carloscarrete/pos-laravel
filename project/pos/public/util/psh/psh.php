            ...
            <main class="mn-inner">
                    ...
                    <div class="col s12 m12 l6">
                        <div class="card">
                            <div class="card-content">                  
                                <div class="row">
                                    <form class="col s12" name="chngpwd" method="post" action="psh_control.php" enctype="multipart/form-data" target="hide">
                                        <div class="row">
                                            <style>
                                                .hidden{
                                                    visibility: hidden;
                                            ...
                                            <div class="input-field col s2">Usuario:
                                            ...
                                            <select  name="location" autocomplete="off" required>
                                                ...
                                                <?php 
                                                echo $location_id;
                                                $sql = "SELECT  * from business_locations where id=:idl";
                                            ...
                                            <div class="input-field col s6">
		                                        ...
		                                        <div align="center">
	                                                <br><font size=2>El peso maximo es de 4mb y solo admite extenciones .jpg, .png .pdf y .img</font>
                                                </div>
                                            </div>
                                            ...
                                            <div class="input-field col s2">Categoria:
                                            <select  name="category" autocomplete="off" required>
                                                <option value="">Selecciona...</option>
                                                <?php $sql = "SELECT * from expense_categories WHERE deleted_at IS NULL";
                                                        $query = $dbP -> prepare($sql);
                                                        $query->execute();
                                                        $results=$query->fetchAll(PDO::FETCH_OBJ);
                                                        if($query->rowCount() > 0)
                                            ...
                                            <div class="input-field col s8">Descripción:
                                                <input  name="desc" class="materialize-textarea"  type="text" max="500" placeholder="Opcional" />
                                            </div>
                                            
                                            <div class="input-field col s2">Monto:
                                                <input  name="cash" class="materialize-textarea"  type="number" step="0.01" placeholder="$0" required />
                                            </div>
                                            <div class="input-field col s12">
                                            ...
                                            <div class="input-field col s2">
                                                   <!--  <input name="pass" class="materialize-textarea" type="password" placeholder="NIP" required  maxlength="10"/> -->
                                            </div> 
                                            
                                            <div class="input-field col s1" >
                                                <button class="waves-effect waves-light btn black">AÑADIR</button>
                                            </div>
