...
@foreach($product_details as $details)
	@while($details['qty'] > 0)
		...
		<div style="display:inline-block;vertical-align:middle;line-height:16px !important;">
			...
			{{-- Barcode --}}
			<img class="center-block" style="max-width:90% !important;max-height: {{$barcode_details->height/4}}in !important; opacity: 10" src="data:image/png;base64,{{DNS1D::getBarcodePNG($details['details']->sub_sku, $details['details']->barcode_type, 2,30,array(39, 48, 54), true)}}">
