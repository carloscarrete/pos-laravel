            	...
            	<table class="table table-bordered table-striped ajax_view" id="sell_table">
                    ...
                    <tfoot>
                        <tr class="bg-gray font-17 footer-total text-center">
                            ...
                            <td class="text-left"><small>@lang('lang_v1.sell_due') - 
                            <span class="display_currency" id="footer_total_remaining" data-currency_symbol ="true"></span>
                            <br>@lang('lang_v1.sell_return_due') - 
                            <span class="display_currency" id="footer_total_sell_return_due" data-currency_symbol ="true"></span></small></td>
                            <td></td>
                        </tr>
                    </tfoot>
            	</table>
