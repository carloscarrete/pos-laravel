        ...
        <div class="col-sm-12">
        	<div class="box">
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <a href="{{ asset('uploads/files/importar_productos.csv') }}" class="btn btn-success" download><i class="fa fa-download"></i> @lang('product.download_csv_file_template')</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="box box-solid">
                ...
                <div class="box-body">
                    ...
                    <table class="table table-striped">
                        ...
                        <tr>
                            <td>35</td>
                            <td>% 1 <small class="text-muted">(@lang('lang_v1.optional'))</small></td>
                        </tr>
                        <tr>
                            <td>36</td>
                            <td>% 2 <small class="text-muted">(@lang('lang_v1.optional'))</small></td>
                        </tr>
                        <tr>
                            <td>37</td>
                            <td>% 3 <small class="text-muted">(@lang('lang_v1.optional'))</small></td>
                        </tr>
                        <tr>
                            <td>38</td>
                            <td>% 4 <small class="text-muted">(@lang('lang_v1.optional'))</small></td>
                        </tr>
