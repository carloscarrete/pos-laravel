...
{!! Form::open(['url' => action('ProductController@update' , [$product->id] ), 'method' => 'PUT', 'id' => 'product_add_form',
  ...
  <input type="" id="product_id" value="{{ $product->id }}">
      ...
      <div class="row">
       ...
       <div class="col-sm-2">
          <div class="form-group">
            ...
            {!! Form::text('product_custom_field1', $product->product_custom_field1, ['class' => 'form-control input_number', 'placeholder' => __('lang_v1.cantidad')]); !!}
          </div>
        </div>
        ...
        <div class="col-sm-1">
          <div class="form-group">
            ...
            {!! Form::text('pct_1', $product->pct_1, ['class' => 'form-control input_number', 'placeholder' => __('lang_v1.percent')]); !!}
          </div>
        </div>
        ...
        <div class="col-sm-2">
          <div class="form-group">
            ...
            {!! Form::text('product_custom_field2', $product->product_custom_field2, ['class' => 'form-control input_number', 'placeholder' => __('lang_v1.cantidad')]); !!}
          </div>
        </div>
        ...
        <div class="col-sm-1">
          <div class="form-group">
            ...
            {!! Form::text('pct_2', $product->pct_2, ['class' => 'form-control input_number', 'placeholder' => __('lang_v1.percent')]); !!}
          </div>
        </div>
        ...
        <div class="col-sm-2">
          <div class="form-group">
            ...
            {!! Form::text('product_custom_field3', $product->product_custom_field3, ['class' => 'form-control input_number', 'placeholder' => __('lang_v1.cantidad')]); !!}
          </div>
        </div>
        ...
        <div class="col-sm-1">
          <div class="form-group">
            ...
            {!! Form::text('pct_3', $product->pct_3, ['class' => 'form-control input_number', 'placeholder' => __('lang_v1.percent')]); !!}
          </div>
        </div>
        ...
        <div class="col-sm-2">
          <div class="form-group">
            ...
            {!! Form::text('product_custom_field4', $product->product_custom_field4, ['class' => 'form-control input_number', 'placeholder' => __('lang_v1.cantidad')]); !!}
          </div>
        </div>
        ...
        <div class="col-sm-1">
          <div class="form-group">
            ...
            {!! Form::text('pct_4', $product->pct_4, ['class' => 'form-control input_number', 'placeholder' => __('lang_v1.percent')]); !!}
          </div>
        </div>
        <!--custom fields-->
  ...
  <div class="box box-solid ">
    <div class="box-body">
      <div class="row">
        ...
        <input type="" id="variation_counter" value="0">
        <input type="" id="default_profit_percent" value="{{ $default_profit_percent }}">
      </div>
    </div>
  </div>
  <div class="row">
    <input type="" name="submit_type" id="submit_type">
        <div class="col-sm-12">
