...
class ProductController extends Controller
{
                ...
                ->addColumn(
                    ...
                    function ($row) use ($selling_price_group_count) {
                        ...
                        if (auth()->user()->can('product.view')) {
                            $html .=
                            '<li><a href="' . action('ProductController@view', [$row->id]) . '" class="view-product hidden"><i class="fa fa-eye"></i> ' . __("messages.view") . '</a></li>';
                        }
                        ...
                        if (auth()->user()->can('product.create')) {
                            ...
                            if ($selling_price_group_count > 0) {
                                $html .=
                                '<li><a href="' . action('ProductController@addSellingPrices', [$row->id]) . '"><i class="fa fa-money hidden"></i> ' . __("lang_v1.add_selling_price_group_prices") . '</a></li>';
                            }
    ...
    public function store(Request $request)
    {
        ...
        try {
            $business_id = $request->session()->get('user.business_id');
            $product_details = $request->only(['name', 'brand_id', 'unit_id', 'category_id', 'tax', 'type', 'barcode_type', 'sku', 'alert_quantity', 'tax_type', 'weight', 'product_custom_field1', 'pct_1', 'product_custom_field2', 'pct_2', 'product_custom_field3', 'pct_3', 'product_custom_field4', 'pct_4', 'product_description']);
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $business_id = $request->session()->get('user.business_id');
            $product_details = $request->only(['name', 'brand_id', 'unit_id', 'category_id', 'tax', 'barcode_type', 'sku', 'alert_quantity', 'tax_type', 'weight', 'product_custom_field1', 'pct_1', 'product_custom_field2', 'pct_2', 'product_custom_field3', 'pct_3', 'product_custom_field4', 'pct_4', 'product_description']);
