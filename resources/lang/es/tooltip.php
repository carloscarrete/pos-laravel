<?php 
 return [ 
"card" => "Declara la cantidad de dinero en transferencias electronicas.",
"cash" => "Declara la cantidad sin descontar el fondo para el siguiente turno (Si declaras descontando el fondo tendras un faltante por la cantidad designada al fondo).",
"caja" => "Declara la cantidad de dinero que se va a destinar para el fondo del siguiente turno.",
