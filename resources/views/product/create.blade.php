      ...
      <div class="row">
        ...
        <div class="col-sm-2">
          <div class="form-group">
            ...
            {!! Form::text('product_custom_field1', !empty($duplicate_product->product_custom_field1) ? $duplicate_product->product_custom_field1 : null, ['class' => 'form-control input_number', 'placeholder' => __('lang_v1.cantidad')]); !!}
          </div>
        </div>
        
        <div class="col-sm-1">
          <div class="form-group">
            {!! Form::label('pct_1',  __('lang_v1.product_custom_field1p') . ':') !!}
            {!! Form::text('pct_1', !empty($duplicate_product->pct_1) ? $duplicate_product->pct_1 : null, ['class' => 'form-control input_number', 'placeholder' => __('lang_v1.percent')]); !!}
          </div>
        </div>
        ...
        <div class="col-sm-2">
          <div class="form-group">
            ...
            {!! Form::text('product_custom_field2', !empty($duplicate_product->product_custom_field2) ? $duplicate_product->product_custom_field2 : null, ['class' => 'form-control input_number', 'placeholder' => __('lang_v1.cantidad')]); !!}
          </div>
        </div>
        
        <div class="col-sm-1">
          <div class="form-group">
            {!! Form::label('pct_2',  __('lang_v1.product_custom_field2p') . ':') !!}
            {!! Form::text('pct_2', !empty($duplicate_product->pct_2) ? $duplicate_product->pct_2 : null, ['class' => 'form-control input_number', 'placeholder' => __('lang_v1.percent')]); !!}
          </div>
        </div>
        ...
        <div class="col-sm-2">
          <div class="form-group">
            ...
            {!! Form::text('product_custom_field3', !empty($duplicate_product->product_custom_field3) ? $duplicate_product->product_custom_field3 : null, ['class' => 'form-control input_number', 'placeholder' => __('lang_v1.cantidad')]); !!}
          </div>
        </div>
        
        <div class="col-sm-1">
          <div class="form-group">
            {!! Form::label('pct_3',  __('lang_v1.product_custom_field3p') . ':') !!}
            {!! Form::text('pct_3', !empty($duplicate_product->pct_3) ? $duplicate_product->pct_3 : null, ['class' => 'form-control input_number', 'placeholder' => __('lang_v1.percent')]); !!}
          </div>
        </div>
        ...
        <div class="col-sm-2">
          <div class="form-group">
            ...
            {!! Form::text('product_custom_field4', !empty($duplicate_product->product_custom_field4) ? $duplicate_product->product_custom_field4 : null, ['class' => 'form-control input_number', 'placeholder' => __('lang_v1.cantidad')]); !!}
          </div>
        </div>
        
        <div class="col-sm-1">
          <div class="form-group">
            {!! Form::label('pct_4',  __('lang_v1.product_custom_field4p') . ':') !!}
            {!! Form::text('pct_4', !empty($duplicate_product->pct_4) ? $duplicate_product->pct_4 : null, ['class' => 'form-control input_number', 'placeholder' => __('lang_v1.percent')]); !!}
          </div>
        </div>
        <!--custom fields-->
      </div>
