...
$ready = "SELECT * from auditorias WHERE sku=:sku_rdy and fecha=:today and id_location=:locate";
...
if($ID){echo "<script type=''>alert('El producto ya fue auditado $FECHA');</script>";}
else{
            ...
            <main class="mn-inner"
                    ...
                    <div class="col s12 m12 l6">
                        <div class="card">
                            <div class="card-content">                  
                                <div class="row">
                                    <form class="col s12" name="chngpwd" method="post" action="locate_p_control.php" enctype="multipart/form-data">
                                        <div class="row">
                                                ...
                                                <table id="example" class="display responsive-table ">
                                                    ...
                                                    if($QyBar_2->rowCount() > 0){  
                                                        foreach($RsBar_2 as $RB_2){
                                                            ...
                                                            $purchase=$RB_2 ->default_purchase_price;?>
                                                                <div class="input-field hidden">
                                                                    <input name="idp" class="materialize-textarea"  type="text" value="<?php echo $P_ID; ?>" readonly required />
                                                                    <input name="pshp" class="materialize-textarea"  type="text" value="<?php echo $purchase; ?>" readonly required />
                                                                </div>
                                                            </td>  
                                                            <?php
                                                            echo "<td>";
                                                        ...
                                                        <div class="input-field ">
                                                            <input name="rly" maxlength='4' onkeypress='return event.charCode >= 48 && event.charCode <= 57' autofocus valign="top"class="materialize-textarea"  type="text-area" placeholder="<?php echo $cant; ?>" required />
                                                        </div></td>
